...
use App\Entity\UserProfile; // Assure-toi d'importer l'entité UserProfile

#[ORM\Entity(repositoryClass: UserRepository::class)]
#[ORM\Table(name: 'users')] // Correction : nous avons confirmé 'users'
...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    {
        // Correction ici : utilise getOwner() et setOwner()
        if ($userProfile === null && $this->userProfile !== null) {
            $this->userProfile->setOwner(null);
        } elseif ($userProfile !== null && $userProfile->getOwner() !== $this) {
